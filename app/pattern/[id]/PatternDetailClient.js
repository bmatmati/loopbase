    ...
    <div style={{ minHeight: '100vh', background: '#f8f7ff', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
      ...
      <div style={{ background: '#3C3489', padding: '40px 24px 60px' }}>
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          ...
          <h2 style={{ fontSize: 18, fontWeight: 700, color: 'white', marginBottom: 6 }}>Track your progress</h2>
            ...
            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
              {progressOptions.map(opt => (
                <button key={opt.value} onClick={() => setProgress(opt.value)} style={{
                  ...
                  border: progress === opt.value ? '2px solid white' : '2px solid rgba(255,255,255,0.2)',
          ...
          <div style={{ background: 'rgba(255,255,255,0.1)', borderRadius: 16, padding: 24, marginBottom: 16 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 24 }}>
              <div style={{ background: 'rgba(255,255,255,0.12)', borderRadius: 12, padding: 16, textAlign: 'center' }}>
            ...
            <div style={{ marginBottom: 20, textAlign: 'center' }}>
              <div style={{ fontSize: 13, color: '#C4BCE8', marginBottom: 16 }}>Stitches in row {currentRow}</div>
