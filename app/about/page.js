      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, marginBottom: 40 }}>
          {[
            ...
            { icon: '💾', title: 'Save your favourites', body: 'Heart any pattern to save it to your collection. Your saved patterns are always there waiting for you when you're ready to start.' },
            { icon: '📊', title: 'Track your progress', body: 'Log your rows, count your stitches and add notes to every pattern you're working on. Our tracker keeps your projects organised.' },
        ...
        <div style={{ background: '#3C3489', borderRadius: 24, padding: '40px', marginBottom: 40, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32, alignItems: 'center' }}>
          <div>
            ...
            <p style={{ fontSize: 15, color: '#C4BCE8', lineHeight: 1.7, margin: 0 }}>We earn a small commission when you buy yarn or hooks through our affiliate links — at no extra cost to you. That's how we keep Loopbase running without ever charging you a penny.</p>
          </div>
        ...
        <div style={{ background: 'white', borderRadius: 20, padding: '32px', border: '1.5px solid #ede9fe', marginBottom: 64, textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 15, color: '#6b7280', marginBottom: 20, lineHeight: 1.7 }}>We're a small independent project and we love hearing from the crochet community. Feedback, suggestions, pattern requests — we read everything.</p>
